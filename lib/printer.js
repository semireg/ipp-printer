...
function Printer(opts) {
  ...
  this.makeModel = opts.makeModel || 'NodeJS ipp-printer';
  this.bonjourType = opts.bonjourType;
...
Printer.prototype.attributes = function(filter) {
  ...
  var attrs = [
    ...
    },
    {
      ...
      value: { lang: 'en-us', value: this.makeModel },
    },
    ...
    { tag: C.KEYWORD, name: 'ipp-versions-supported', value: '1.1' }, // 1.0, 1.1
    {
      ...
      value: [
        ...
        C.VALIDATE_JOB,
        C.GET_JOBS,
        C.GET_PRINTER_ATTRIBUTES,
        C.CANCEL_JOB,
        C.GET_JOB_ATTRIBUTES,
      ],
    },
  ...
  const allAttrs = attrs.filter(function(attr) {
